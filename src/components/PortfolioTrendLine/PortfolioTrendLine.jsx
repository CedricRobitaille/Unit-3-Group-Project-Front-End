...
<<<<<<< HEAD
                <div className="card-top-container">
                    ...
                    <form onChange={handleRangeSelection} className="range-picker-container">
                        <button className="range-picker">24hr</button>
                        <button className="range-picker">7d</button>
                        <button className="range-picker">30d</button>
                        <button className="range-picker">3m</button>
                    </form>
